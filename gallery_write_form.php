...
<html>
  <head>
    <meta charset="utf-8">
   <link href="../../common_css/index_css.css" rel="stylesheet"
  ...
  <header>
    ...
    <nav id="top">
      <?php include_once '../../common_lib/main_menu2.php'; ?>
        ...
        <section id="section">
      <article class="main">
        <div style="padding-left: 600px;" id="head">
          <h1>게시글 작성</h1>
        </div>
        <hr width="50%" size="3px" color="black">
  <?php 
 ...
 ?>
  ...
  <div style="/* padding-left: 600px; */ table-layout: fixed; margin: 100px;" id="table_form">
...
<div style="padding-left: 1300px;" id="write_button">
